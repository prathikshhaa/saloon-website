...
const slides = [
  {
    ...
    subtitle:
      "Luxury beauty, grooming and self-care experiences crafted for modern lifestyles.",
...

  {
    ...
    subtitle:
      "Premium styling, skincare and grooming designed for confidence and elegance.",
